    ...
    <main className="about">
      ...
      <div className="about__container">
        <div className="about__container--text">
          <p>
            <i class="fa-solid fa-hammer"></i> Je suis un développeur web
          ...
          <p>
            <i class="fa-sharp fa-solid fa-graduation-cap"></i> Mon parcours de
            développeur débute en juillet 2022, lorsque j'ai commencé à me
          ...
          <p>
            <i class="fa-solid fa-laptop-code"></i> Ma motivation pour le
